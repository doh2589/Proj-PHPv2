...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            <div class="row">
            <label for="name" class="col-sm-3 control-label">เวลาโอน</label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <div class="row">
            <label for="name" class="col-sm-3 control-label">อัพโหลดสลีปโอนเงิน</label>
            <div class="col-sm-9">
                <input type="file" name="txt_file" class="form-control">
            </div>
            </div>
